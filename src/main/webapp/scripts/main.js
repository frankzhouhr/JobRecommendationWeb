// immediate act function to avoid conflicts between other existing imported js files
(function() {
    ...
    function init() {
        ...
        // make sure event listenser has added before rendering
        validateSession();
     ...
     * Session
     */
    /** Check is the user has logged in by checking the session...*/
    ...
    function onSessionValid(result) { // After login works
    ...
    /** When the session is invalid - before we log in...*/
    ...
    // show element using given or default style
    ...
    function onLoadPositionFailed() {
        ...
        getLocationFromIP(); // try another way, extract geo from IP address
    }
    ...
    function register() {
        ...
        // regular expression
        // a - z, 0 - 9  + "+" means length much be greater than 0
        if (username.match(/^[a-z0-9_]+$/) === null) {
            showRegisterResult('Invalid username');
            return
        }
        // globally update password
        // Why encoding?
        // protect user information from request info
        password = md5(username + md5(password));
    ...
    function activeBtn(btnId) {
        ...
        // high light the button => CSS attribute: active
    ...
    function ajax(method, url, data, successCallback, errorCallback) {
        ...
        // call this function when request has been complete
        xhr.onload = function() {
            if (xhr.status === 200) {
